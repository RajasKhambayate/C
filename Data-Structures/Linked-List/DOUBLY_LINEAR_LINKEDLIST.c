...
void InsertFirst(PPsNODE pHead,int iNo)
{
    ...
    printf("Node with data %d inserted at the beginning of the doubly linear linked list\n",iNo);
}
...
void InsertLast(PPsNODE pHead,int iNo)
{
    ...
    printf("Node with data %d inserted at the end of the doubly linear linked list\n",iNo);
}
...
//4. If the position is 1, store the address of the first node in a temporary pointer and update  //
//   the first pointer with the address of the new node and update the Next pointer of the new    //
//   node with the address of the first node.                                                     //
//5. If the position is the last, traverse till the second last node and update the Next pointer  //
//   of the last node with the address of the new node.                                           //
...
void InsertAtPosition(PPsNODE pHead,int iNo,int iPosition)
{
    ...
    if((iPosition < 1) || (iPosition > (iSize + 1)))//If position is invalid
    {
        while(iCnt <= 2)
        {
            ...
            {
                InsertAtPosition(pHead,iNo,iPosition);
                return;
            }
...
//3. If the linked list contains more than one node, update the first pointer with the address of //
//   the second node and free the memory of the first node.                                       //
//4. Update the previous pointer of the second node to NULL .                                     //
////////////////////////////////////////////////////////////////////////////////////////////////////
void DeleteFirst(PPsNODE pHead)
{
    if(*pHead == NULL)//If linkedlist is empty
    {
        printf("Linkedlist is empty\n");
...
//4. Update the previous pointer of the last node to NULL .                                       //
////////////////////////////////////////////////////////////////////////////////////////////////////
void DeleteLast(PPsNODE pHead)
{
    if(*pHead == NULL)//If linkedlist is empty
    {
        printf("Linkedlist is empty\n");
    ...
    else//If linkedlist contains multiple two node
    {
        ...
        printf("Node %d deleted from the end of the doubly linear linked list\n",ptemp -> pNext -> iData);
...
////////////////////////////////////////////////////////////////////////////////////////////////////
//DeleteAtPosition() Function: Deletes a node from the given position of the from doubly linear   //
// linked list .                                                                                  //
//================================================================================================//
//Parameters:                                                                                     //
//1. PPsNODE : Address of the first pointer of the linked list .                                  //
...
//2. Count the number of nodes in the linked list .                                               //
//3. If the position is invalid, display a message that the position is invalid.                  //
//4. If the position is 1, update the first pointer with the address of the second node and free  //
//   the memory of the first node.                                                                //
//5. If the position is the last, traverse till the second last node and delete the last node.    //
//6. If the position is random, traverse till the node before the specified position and update   //
//   the Next pointer of the previous node with the Next pointer of the node to be deleted and    //
//   free the memory of the node to be deleted.                                                   //
//7. Update the previous pointer of the next node to the previous node .                          //
////////////////////////////////////////////////////////////////////////////////////////////////////
void DeleteAtPosition(PPsNODE pHead,int iPosition)
{
    if(*pHead == NULL)//If linkedlist is empty
    {
        printf("Linkedlist is empty\n");
    ...
    if((iPosition < 1) || (iPosition > iSize))//If position is invalid
    {
        ...
        while(iCnt <= 2)
        {
            ...
            {
                DeleteAtPosition(pHead,iPosition);
                return;
            }
    ...
    if((*pHead) -> pNext == NULL)//If linkedlist contains one node
    {
        printf("Node with data %d deleted from doubly linear linked list\n",(*pHead) -> iData);
    ...
    else if(iPosition == iSize)//If position last
    {
        ...
        printf("Node with data %d deleted from the end of the doubly linear linked list\n",ptempdelete -> pNext -> iData);
    ...
    else//Random position
    {
        ...
        printf("Node with data %d deleted from the position %d from doubly linear linked list\n",ptemp -> pNext -> pPrev -> iData,iPosition);
...
////////////////////////////////////////////////////////////////////////////////////////////////////
//Search() Function: Searches for a specific value in doubly linear linked list .                 //
//================================================================================================//
//Parameters:                                                                                     //
//1. PsNODE : Address of the first pointer of the linked list .                                   //
...
////////////////////////////////////////////////////////////////////////////////////////////////////
bool Search(PsNODE pHead,int iSearch)
{
    if(pHead == NULL)
    {
        printf("Linkedlist is empty\n");
...
////////////////////////////////////////////////////////////////////////////////////////////////////
//UpdateNoForNo() Function: Updates the value in exchange of a specific value from doubly linear  //
// linked list .                                                                                  //
//================================================================================================//
//Parameters:                                                                                     //
//1. PsNODE : Address of the first pointer of the linked list .                                   //
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void UpdateNoForNo(PsNODE pHead,int iSearch,int iUpdate)
{
    if(pHead == NULL)
    {
        printf("Linkedlist is empty\n");
...
////////////////////////////////////////////////////////////////////////////////////////////////////
//UpdateNoForPosition() Function: Updates the value in at a specific position from doubly linear  //
// linked list .                                                                                  //
//================================================================================================//
//Parameters:                                                                                     //
//1. PsNODE : Address of the first pointer of the linked list .                                   //
...
void UpdateNoForPosition(PsNODE pHead,int iUpdate,int iPosition)
{
    ...
    if((iPosition < 1) || (iPosition > (iSize + 1)))
    {
        for(iCnt = 0;iCnt <= 2;iCnt++)
        {
            ...
            if((iPosition >= 1) && (iPosition <= (iSize + 1)))
            {
                UpdateNoForPosition(pHead,iUpdate,iPosition);
                return;
            }
        }
...
//4. Traverse the first linked list till the last node and update the Next pointer of the last    //
//   node with the address of the first node of the second linked list.                           //
//5. Free the second linked list.                                                                 //
//6. Update the previous pointer of the first node of the second linked list to the last node of  //
//   the first linked list.                                                                       //
//7. Set the first pointer of the second linked list to NULL .                                    //
//8. Return .                                                                                     // 
////////////////////////////////////////////////////////////////////////////////////////////////////
void Concat(PPsNODE pHead1,PPsNODE pHead2)
{
...
void InsertBefore(PPsNODE pHead,int iNo,int iPosition)
{
    ...
    if((iPosition < 1) || (iPosition > (iSize)))
    {
        for(iCnt = 0;iCnt <= 2;iCnt++)
        {
            ...
            if((iPosition >= 1) && (iPosition <= (iSize)))
            {
                InsertBefore(pHead,iNo,iPosition);
                return;
            }
        }
...
void InsertAfter(PPsNODE pHead,int iNo,int iPosition)
{
    ...
    if((iPosition < 1) || (iPosition > (iSize)))
    {
        for(iCnt = 0;iCnt <= 2;iCnt++)
        {
            ...
            if((iPosition >= 1) && (iPosition <= (iSize)))
            {
                InsertAfter(pHead,iNo,iPosition);
                return;
            }
        }
...
//   free the memory of the node to be deleted.                                                   //
////////////////////////////////////////////////////////////////////////////////////////////////////
void DeleteBefore(PPsNODE pHead,int iPosition)
{
    if(*pHead == NULL)
    {
        printf("linkedlist are empty\n");
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void DeleteAfter(PPsNODE pHead,int iPosition)
{
    if(*pHead == NULL)
    {
        printf("linkedlist are empty\n");
...
void DeleteList(PPsNODE pHead)
{
    ...
    printf("Doubly Linear Linked List has been deleted\n");
}
...
void SortAscending(PsNODE pHead)
{
    ...
    printf("Doubly Linear Linked List has been sorted as in ascending order\n");
}


////////////////////////////////////////////////////////////////////////////////////////////////////
//Reverse() Function: Reverses the order of data form doubly linear linked list .                 //
//================================================================================================//
//Parameters:                                                                                     //
//1. PPsNODE : Address of the first pointer of the linked list .                                  //
//================================================================================================//
...
void Reverse(PPsNODE pHead)
{
    ...
    printf("Doubly Linear Linked List's data has been reversed\n");
}
...
////////////////////////////////////////////////////////////////////////////////////////////////////
PsNODE FindKthNodeFromStart(PsNODE pHead)
{
    if(pHead == NULL)
    {
        printf("linkedlist is empty\n");
...
////////////////////////////////////////////////////////////////////////////////////////////////////
PsNODE FindKthNodeFromMiddle(PsNODE pHead)
{
    if(pHead == NULL)
    {
        printf("linkedlist is empty\n");
...
//   return the address of the kth node.                                                          //
////////////////////////////////////////////////////////////////////////////////////////////////////
PsNODE FindKthNodeFromEnd(PsNODE pHead)
{
    if(pHead == NULL)
    {
        printf("linkedlist is empty\n");
...
void Manual()
{
    printf("::::MANUAL FOR RAJAS's DOUBLY LINEAR LINKED LIST APPLICATION::::\n\n\n");
...
int main()
{
    ...
    printf("Welcome to Rajas's Application of Doubly-Linear-LinkedList\n\n");
    ...
    while(1)
    {
            ...
            while(iExitMode != 1)
            {
                ...
                switch(cChoiceFunction)
                {
                    ...
                    case 'f':
                        ...
                        DeleteAtPosition(&pHead1,iPosition1);
            ...
            while(iExitMode != 1)
            {
                ...
                switch(cChoiceFunction)
                {
                    ...
                    case 'n':
                        ...
                        UpdateNoForNo(pHead1,iNo1,iNo2);
                    ...
                    case 'r':
                        ...
                        DeleteBefore(&pHead1,iPosition1);
                    ...
                    case 'X':
                    case 'x':
                        pRet = FindKthNodeFromStart(pHead1);

                        break;
                    case 'Y':
                    case 'y':
                        pRet = FindKthNodeFromMiddle(pHead1);

                        break;
                    case 'Z':
                    case 'z':
                        pRet = FindKthNodeFromEnd(pHead1);
        ...
        {
            printf("Exiting the RAJAS's DOUBLY LINEAR LINKEDLIST application\n");
            break;
        }
        else
        {
