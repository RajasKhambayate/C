...
//program demonstrates the implementation of Generic Doubly Circular Linked List .                //
//================================================================================================//
//Language: C++                                                                                   //
//Compiler : GNU G++                                                                              //
...
struct sNode//Structure declaration for node in Generic Doubly Circular Linked List
{
...
class DOUBLY_CIRCULAR_LINKEDLIST
{
    private:
        ...
        DOUBLY_CIRCULAR_LINKEDLIST();//Constructor to initialize the doubly circular linked list
        ~DOUBLY_CIRCULAR_LINKEDLIST();//Destructor to delete the doubly circular linked list
...
template<class Generic>
DOUBLY_CIRCULAR_LINKEDLIST<Generic>::DOUBLY_CIRCULAR_LINKEDLIST()
{
    pHead = nullptr;
    pTail = nullptr;
    iCountNode = 0;
...
////////////////////////////////////////////////////////////////////////////////////////////////////
//DeleteBefore() Function: Removes a node before a specified node from doubly circular linked list//
//================================================================================================//
//Parameters:                                                                                     //
    ...
    while(1)
    {
        ...
        if(atoi(siChoiceMode) == 1)
        {
            if(iEntryCount != 0)
            {
                ...
                {
                    DoublyCircularLL_Integer.~DOUBLY_CIRCULAR_LINKEDLIST();
                    DOUBLY_CIRCULAR_LINKEDLIST <int>DoublyCircularLL_Integer;
                }
            }
            iEntryCount++;
                ...
                else if(atoi(siChoiceMode) == 2)
                {
                    ...
                    while(atoi(siChoiceMode) != 1)
                    {
                        ...
                        switch(cChoiceFunction)
                        {
                            ...
                            case 'H':
                            case 'h':
                                iRet = DoublyCircularLL_Integer.Count();
        ...
        else if(atoi(siChoiceMode) == 2)
        {
            if(fEntryCount != 0.0f)
            {
                ...
                if((siChoiceMode[0] == 'N') || (siChoiceMode[0] == 'n'))
                {
                    DoublyCircularLL_Float.~DOUBLY_CIRCULAR_LINKEDLIST();
                    DOUBLY_CIRCULAR_LINKEDLIST <float>DoublyCircularLL_Float;
                }
            }
            fEntryCount++;
