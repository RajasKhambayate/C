            ...
            while(iExitMode != 1)
            {
                ...
                switch(cChoiceFunction)
                {
                    ...
                    case 'c':
                        ...
                        printf("Node with data %d inserted at the position %d of the singly linear linked list\n",iNo1,iPosition1);
                    ...
                    case 'd':
                        ...
                        {
                            printf("The singly linear linked list is empty\n");
                        }
                    ...
                    case 'f':
                        if((iRet = Count(pHead1)) != 0)
                        {
                            ...
                            printf("Node with data %d deleted from the position %d from the singly linear linked list\n",iRet,iPosition1);
                        }
                        else
                        {
                            printf("The singly linear linked list is empty\n");
            ...
            while(iExitMode != 1)
            {
                ...
                switch(cChoiceFunction)
                {
                    ...
                    case 'j':
                        ...
                        {
                            Reverse(&pHead1);
                            printf("The singly linear linked list has been reversed\n");
                        }
                        else
                        {
                            printf("The singly linear linked list is empty\n");
                    ...
                    case 'm':
                        if((iRet = Count(pHead1)) != 0)
                        {
                            ...
                            printf("The singly linear linked list has been sorted in ascending order\n");
                        }
                        else
                        {
                            printf("The singly linear linked list is empty\n");
                    ...
                    case 'n':
                        if((iRet = Count(pHead1)) != 0)
                        {
                            ...
                            if(bRet == true)
                            {
                                printf("Element %d has been updated to %d in the singly linear linked list\n",iNo1,iNo2);
                            }
                            else
                            {
                                printf("Element %d not found in the singly linear linked list\n",iNo1);
                            }
                        }
                        else
                        {
                    ...
                    case 'o':
                        if((iRet = Count(pHead1)) != 0)
                        {
                            ...
                            printf("Element at position %d has been updated to %d in the singly linear linked list\n",iPosition1,iNo1);
                        }
                        else
                        {
                            printf("The singly linear linked list is empty\n");
                    ...
                    case 'p':
                        if((iRet = Count(pHead1)) != 0)
                        {
                            ...
                            printf("Node with data %d has been inserted before position %d in the singly linear linked list\n",iNo1,iPosition1);
                        }
                        else
                        {
                            printf("The singly linear linked list is empty\n");
                    ...
                    case 'q':
                        if((iRet = Count(pHead1)) != 0)
                        {
                            ...
                            printf("Node with data %d has been inserted after position %d in the singly linear linked list\n",iNo1,(iPosition1 + 1));
                        }
                        else
                        {
                            printf("The singly linear linked list is empty\n");
                    ...
                    case 'r':
                        if((iRet = Count(pHead1)) != 0)
                        {
                            ...
                            printf("Node with data %d has been deleted after position %d in the singly linear linked list\n",iRet,iPosition1);
                        }
                        else
                        {
                            printf("The singly linear linked list is empty\n");
                    ...
                    case 's':
                        if((iRet = Count(pHead1)) != 0)
                        {
                            ...
                            printf("Node with data %d has been deleted before position %d in the singly linear linked list\n",iRet,iPosition1);
                        }
                        else
                        {
                            printf("The singly linear linked list is empty\n");
                    ...
                    case 't':
                        ...
                        {
                            DeleteList(&pHead1);
                            printf("All nodes have been deleted from the singly linear linked list\n");
                        }
                        else
                        {
                            printf("The singly linear linked list is empty\n");
