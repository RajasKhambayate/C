...
int DeleteAtPosition(PPsNODE pHead,int iPosition)
{
    ...
    if(iPosition == 1)//If position is 1
    {
        iDeleted = DeleteFirst(pHead);
        return iDeleted;
    }
    else if(iPosition == iSize)//If position last
    {
        iDeleted = DeleteLast(pHead);
        return iDeleted;
    }
    else//Random position
    {
        ...
        iDeleted = ptemp -> pNext -> pPrev -> iData;
...
//Parameters:                                                                                     //
//1. PsNODE : Address of the first pointer of the linked list .                                   //
//2. int : integer to store kth position from end .                                             //
//================================================================================================//
//Return: PsNODE                                                                                  //
//================================================================================================//
//Local variables:                                                                                //
...
//3. int : integer to store counter variable .                                                    //
////////////////////////////////////////////////////////////////////////////////////////////////////
PsNODE FindKthNodeFromEnd(PsNODE pHead,int iKth,int iDirection)
{
    PsNODE ptemp = pHead;
    int iSize = Count(pHead);
            ...
            while(iExitMode != 1)
            {
                ...
                switch(cChoiceFunction)
                {
                    ...
                    case 'c':
                        ...
                        while((iPosition1 < 1) || (iPosition1 > (iRet = (Count(pHead1) + 1))))
                        {
                        ...
                        printf("Node with data %d inserted at the position %d of the doubly linear linked list\n",iNo1,iPosition1);
                    ...
                    case 'd':
                        ...
                        {
                            printf("The doubly linear linked list is empty\n");
                        }
                    ...
                    case 'f':
                        if((iRet = Count(pHead1)) != 0)
                        {
                            ...
                            while((iPosition1 < 1) || (iPosition1 > (iRet = Count(pHead1))))
                            {
                                printf("Invalid position. Please enter a position between 1 and %d : ",(iRet + 1));
                                scanf("%d",&iPosition1);
                            }
                            ...
                            printf("Node with data %d deleted from the position %d from the doubly linear linked list\n",iRet,iPosition1);
                        }
                        else
                        {
                            printf("The doubly linear linked list is empty\n");
            ...
            while(iExitMode != 1)
            {
                ...
                switch(cChoiceFunction)
                {
                    ...
                    case 'j':
                        ...
                        {
                            Reverse(&pHead1);
                            printf("The doubly linear linked list has been reversed\n");
                        }
                        else
                        {
                            printf("The doubly linear linked list is empty\n");
                    ...
                    case 'm':
                        if((iRet = Count(pHead1)) != 0)
                        {
                            ...
                            printf("The doubly linear linked list has been sorted in ascending order\n");
                        }
                        else
                        {
                            printf("The doubly linear linked list is empty\n");
                    ...
                    case 'n':
                        if((iRet = Count(pHead1)) != 0)
                        {
                            ...
                            if(bRet == true)
                            {
                                printf("Element %d has been updated to %d in the doubly linear linked list\n",iNo1,iNo2);
                            }
                            else
                            {
                                printf("Element %d not found in the doubly linear linked list\n",iNo1);
                            }
                        }
                        else
                        {
                    ...
                    case 'o':
                        if((iRet = Count(pHead1)) != 0)
                        {
                            ...
                            printf("Element at position %d has been updated to %d in the doubly linear linked list\n",iPosition1,iNo1);
                        }
                        else
                        {
                            printf("The doubly linear linked list is empty\n");
                    ...
                    case 'p':
                        if((iRet = Count(pHead1)) != 0)
                        {
                            ...
                            printf("Node with data %d has been inserted before position %d in the doubly linear linked list\n",iNo1,iPosition1);
                        }
                        else
                        {
                            printf("The doubly linear linked list is empty\n");
                    ...
                    case 'q':
                        if((iRet = Count(pHead1)) != 0)
                        {
                            ...
                            printf("Node with data %d has been inserted after position %d in the doubly linear linked list\n",iNo1,(iPosition1 + 1));
                        }
                        else
                        {
                            printf("The doubly linear linked list is empty\n");
                    ...
                    case 'r':
                        if((iRet = Count(pHead1)) != 0)
                        {
                            ...
                            printf("Node with data %d has been deleted after position %d in the doubly linear linked list\n",iRet,iPosition1);
                        }
                        else
                        {
                            printf("The doubly linear linked list is empty\n");
                    ...
                    case 's':
                        if((iRet = Count(pHead1)) != 0)
                        {
                            ...
                            printf("Node with data %d has been deleted before position %d in the doubly linear linked list\n",iRet,iPosition1);
                        }
                        else
                        {
                            printf("The doubly linear linked list is empty\n");
                    ...
                    case 't':
                        ...
                        {
                            DeleteList(&pHead1);
                            printf("All nodes have been deleted from the doubly linear linked list\n");
                        }
                        else
                        {
                            printf("The doubly linear linked list is empty\n");
                    ...
                    case 'x':
                        if((iRet = Count(pHead1)) != 0)
                        {
                            ...
                            while((iNo1 < 1) || (iNo1 > (iRet = Count(pHead1))))
                            {
                                printf("Invalid position. Please enter a position between 1 and %d : ",iRet);
                                scanf("%d",&iNo1);
                            }
                    ...
                    case 'y':
                        if((iRet = Count(pHead1)) != 0)
                        {
                            ...
                            while((iNo1 < 1) || (iNo1 > (iRet = (Count(pHead1) / 2))))
                            {
                                printf("Invalid position. Please enter a position between 1 and %d : ",iRet);
                                scanf("%d",&iNo1);
                            }
